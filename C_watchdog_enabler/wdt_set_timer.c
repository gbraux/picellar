...
{
	printf("========================================\n");
  printf("Raspberry Pi BCM2835 Watchdog Config\n");
	printf("========================================\n");
  ...
  ioctl(deviceHandle, WDIOC_GETTIMEOUT, &oldtimeout);
  printf("The watchdog old timeout was %d seconds.\n", oldtimeout);
  
	ioctl(deviceHandle, WDIOC_SETTIMEOUT, &newtimeout);
	printf("The watchdog new timeout is now %d seconds.\n", newtimeout);
